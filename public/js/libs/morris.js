...
(function() {
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.redraw = function() {
      ...
      this.text1 = this.drawEmptyDonutLabel(cx, cy - 10, this.options.labelColor, 16, 800);
      this.text2 = this.drawEmptyDonutLabel(cx, cy + 10, this.options.labelColor, 16, 400);
    ...
    Donut.prototype.select = function(idx) {
      ...
      segment.select();
      row = this.data[idx];
      return this.setLabels(this.options.topLabel, this.options.bottomLabel);
    };
  ...
  Morris.DonutSegment = (function(_super) {
    ...
    function DonutSegment(cx, cy, inner, outer, p0, p1, color, backgroundColor, index, raphael) {
      ...
      this.path = this.calcSegment(this.inner + 3, this.inner + this.outer);
